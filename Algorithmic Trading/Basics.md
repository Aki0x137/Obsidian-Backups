...
3. **Two Possible Outcomes:**
    ...
    - **Case 2: The Remaining Passive Orders Have Prices Worse Than the Limit Price of the Aggressive Order.**
        ...
        - For instance:
            ...
            - However, the remaining 20 shares priced at $51 are higher than the buyer's limit of $50, so no match occurs for those shares. The unmatched part of the buy order (20 shares) remains un-executed or gets cancelled if it was a market order.
